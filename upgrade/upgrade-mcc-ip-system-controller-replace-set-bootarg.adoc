...
[role="lead"]
Für Upgrades von Systemen, die in ONTAP 9.15.1 oder höher eingeführt wurden, müssen Sie vor dem Upgrade ein Boot-arg auf den alten Controllern einrichten.
...
| Alle anderen unterstützten Upgrades für AFF A70, AFF A90, AFF A1K, FAS70-, FAS90-, AFF C80-, AFF A50-, AFF A30-, AFF C30-, AFF C60- oder FAS50-Systeme | `hw.cxgbe.toe_keepalive_disable` 
|===
