...
.Über diese Aufgabe
* Sie benötigen die UUIDs und System-IDs, die zuvor im Upgrade-Verfahren in identifiziert <<gather_info_so_sb,Sammeln Sie vor dem Upgrade Informationen>>wurden.
