...
image:../media/mccip_manual_controller_upgrade_comb.png["Zeigt die unterstützten AFF und FAS Plattformen für manuelles Upgrade von Controllern mithilfe von Switchover und Switchback"]
