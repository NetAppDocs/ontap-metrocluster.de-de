...
---
= Auswahl eines MetroCluster Verfahrens zur Controller-Aktualisierung
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Hinweis 4: Bei der Aufrüstung integrierter Systeme (Festplatten und Controller im selben Gehäuse) müssen die Controller-Module ausgetauscht werden, während das bestehende Gehäuse und die Festplatten beibehalten werden.
...
image:../media/manual-upgrade-combination-group-2-a90-fas90-updated.png["Zeigt die unterstützten Upgrade-Kombinationen für die Plattformen der Gruppe 2"]
