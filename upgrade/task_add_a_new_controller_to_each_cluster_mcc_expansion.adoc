...
---
= Einem MetroCluster FC Cluster wird jeweils ein neues Controller Modul hinzugefügt.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_mcc_2_to_4_node_expansion_adding_nodes.gif[Workflow zum Hinzufügen neuer Controllermodule in der MetroCluster -Erweiterung von 2 auf 4 Knoten]
