...
---
= Konfiguration von Intercluster-LIFs während einer Erweiterung von zwei auf vier Knoten für MetroCluster FC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Hier wird erläutert, wie Intercluster-LIFs auf dedizierten und gemeinsam genutzten Ports während einer Erweiterung von zwei auf vier Knoten in einer MetroCluster FC Konfiguration konfiguriert werden.
