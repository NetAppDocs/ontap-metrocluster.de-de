...
Tiebreaker
 a| 
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations["Hinzufügen von MetroCluster Konfigurationen"] im Abschnitt _MetroCluster Tiebreaker Installation und Konfiguration_.
