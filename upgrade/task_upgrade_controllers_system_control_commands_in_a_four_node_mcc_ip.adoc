...
Damit das Netzwerk auf den neuen Controllern ordnungsgemäß fortgesetzt werden kann, überprüfen Sie, ob die LIF-Platzierung korrekt ist, und entfernen Sie die Netzwerkkonfiguration der alten Controller.
