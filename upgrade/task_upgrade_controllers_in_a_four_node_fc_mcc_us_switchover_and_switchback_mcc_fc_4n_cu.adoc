...
---
= Aktualisieren Sie Controller in einer MetroCluster FC Konfiguration mithilfe von Switchover und Switchback
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
e3a, e3b
 a| 
Kein passender Port. Erstellen Sie nach dem Upgrade die Clusterports neu. link:task_prepare_cluster_ports_on_the_exist_controller.html["Bereiten Sie Cluster-Ports auf einem vorhandenen Controller-Modul vor"]
...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["MetroCluster-Konfigurationen entfernen"]
...
image::../media/mcc_upgrade_cluster_a_in_switchover.png[Site_B inaktiv und bereit für ein Upgrade nach der MetroCluster -Umschaltung]
...
== Entfernen Sie die alten Plattformen
...
Die alten System-IDs wurden in identifiziert link:task_upgrade_controllers_in_a_four_node_fc_mcc_us_switchover_and_switchback_mcc_fc_4n_cu.html["Sammeln Sie vor dem Upgrade Informationen"].
...
. Wenn die Root-Volume-Verschlüsselung verwendet wird, wählen Sie je nach verwendeter ONTAP-Version die entsprechende Option im Bootmenü aus oder führen Sie den Bootmenü-Befehl erneut aus, um Ihre Schlüsselverwaltungskonfiguration zu konfigurieren.
+
[role="tabbed-block"]
====
.ONTAP 9.8 und höher
...
.Schritt
. Wiederholen Sie die Schritte, um die Knoten auf Cluster_A zu aktualisieren, beginnend mit link:task_upgrade_controllers_in_a_four_node_fc_mcc_us_switchover_and_switchback_mcc_fc_4n_cu.html["Bereiten Sie sich auf das Upgrade vor"].
+
...
. Verwenden Sie die Schritte in  http://docs.netapp.com/ontap-9/topic/com.netapp.doc.hw-metrocluster-tiebreaker/GUID-7259BCA4-104C-49C6-BAD0-1068CA2A3DA5.html["Fügen Sie MetroCluster-Konfigurationen hinzu"^] in _Installation und Konfiguration des MetroCluster-Tiebreakers_.
