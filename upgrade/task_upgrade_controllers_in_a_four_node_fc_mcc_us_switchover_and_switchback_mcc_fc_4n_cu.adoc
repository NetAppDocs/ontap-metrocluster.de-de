...
e3a, e3b
 a| 
Kein passender Port. Erstellen Sie nach dem Upgrade die Clusterports neu. link:task_prepare_cluster_ports_on_the_exist_controller.html["Vorbereiten von Cluster-Ports auf einem vorhandenen Controller-Modul"]
