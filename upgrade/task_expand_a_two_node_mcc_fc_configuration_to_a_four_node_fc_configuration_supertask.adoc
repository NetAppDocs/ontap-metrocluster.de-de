...
+
image::../media/mcc_dr_groups_2_node.gif[MetroCluster FC-Konfiguration mit zwei Knoten vor der Erweiterung]

+
Nach Abschluss dieses Verfahrens besteht die MetroCluster FC-Konfiguration aus zwei HA-Paaren an jedem Standort:

+
image::../media/mcc_dr_groups_4_node.gif[MetroCluster FC-Konfiguration mit vier Knoten nach der Erweiterung]
...
image::../media/workflow_mcc_2_to_4_node_expansion_high_level.gif[Workflow für die Erweiterung von MetroCluster FC von 2 auf 4 Knoten]
