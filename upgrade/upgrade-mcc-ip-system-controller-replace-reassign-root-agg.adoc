...
---
= Die Root-Aggregat-Disks werden dem neuen MetroCluster IP Controller neu zugewiesen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
.Schritte
. Alle anderen Verbindungen, die von den alten Controller-Modulen getrennt wurden, mit den neuen Controller-Modulen verkabeln.
