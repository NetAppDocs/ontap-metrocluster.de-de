...
. Verschieben Sie die Daten von den alten Nodes auf die neuen Nodes, indem Sie die folgenden Verfahren in ausführen link:https://docs.netapp.com/us-en/ontap-systems-upgrade/index.html["Dokumentation zu ONTAP Hardwaresystemen"^]
+
