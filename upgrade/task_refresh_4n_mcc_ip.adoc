...
---
= Aktualisierung einer MetroCluster IP Konfiguration mit vier oder acht Knoten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Die Tabelle zeigt alle Plattformmodelle, die *gemeinsame MetroCluster/HA-Ports* und *gemeinsame Cluster/HA-Ports* verwenden. Nicht alle Kombinationen werden von diesem Verfahren unterstützt. In der link:concept_choosing_tech_refresh_mcc.html#supported-metrocluster-ip-tech-refresh-combinations["Unterstützte Plattformkombinationen"] kann überprüft werden, ob die jeweilige Aktualisierungskombination unterstützt wird.
...
Tiebreaker
 a| 
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb["Hinzufügen von MetroCluster Konfigurationen"] in der _MetroCluster Tiebreaker Installation und Konfiguration_.
