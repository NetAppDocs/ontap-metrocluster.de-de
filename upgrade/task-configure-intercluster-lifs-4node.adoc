...
---
= Konfiguration von Intercluster-LIFs während einer Erweiterung von vier auf acht Knoten in einer MetroCluster FC Konfiguration
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Informationen zum Konfigurieren von Intercluster-LIFs auf dedizierten und gemeinsam genutzten Ports während einer Erweiterung von vier auf acht Knoten in einer MetroCluster FC Konfiguration.
