...
.. Konfigurieren Sie den neuen Switch, wie in _MetroCluster Installation und Konfiguration beschrieben, überspringen Sie jedoch das Verfahren „`Zoning auf Brocade FC Switches`“.
+
