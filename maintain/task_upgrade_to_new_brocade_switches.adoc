...
---
= Upgrade auf neue Brocade FC Switches in einer MetroCluster FC Konfiguration
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Brocade -Upgrade auf G620 nach Abschluss]
...
----
+
image::../media/brocade_upgr_to_g620_fab_1_down.gif[Brocade -Upgrade auf G620 mit heruntergefahrenem Fabric 1]
...
+
image::../media/brocade_upgr_to_g620_replaced_a_1.gif[Brocade -Upgrade auf G620 mit A1-Ersatz]
...
+
image::../media/brocade_upgr_to_g620_replaced_b_1.gif[Brocade -Upgrade auf G620 mit B1-Ersatz]
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Workflow für MetroCluster nach dem Austausch des Brocade G620-Switches und Abschluss des Upgrades]
