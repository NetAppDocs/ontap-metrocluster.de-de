...
** link:../install-ip/task_switch_config_cisco.html#download-and-install-the-cisco-ip-rcf-files["Laden Sie die Cisco IP-RCFs herunter, und installieren Sie sie"]
