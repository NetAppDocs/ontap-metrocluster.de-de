...
NOTE: Wenn Ihr Switch bereits richtig konfiguriert ist, können Sie diese nächsten Abschnitte überspringen und direkt zu gehen  MACsec encryption on Cisco 9336C switches, Sofern zutreffend oder für  the new NS224 shelf.
