...
summary: Die Tiebreaker 1.5 Software bietet Monitoring-Funktionen für eine Clustered Storage-Umgebung. Außerdem sendet er SNMP-Benachrichtigungen, wenn Probleme mit der Node-Konnektivität oder im Falle eines Standortnotfalls auftreten. 
---
= Installieren Sie MetroCluster Tiebreaker 1.5-Abhängigkeiten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. <<install-java-17,Installieren Sie JDK>>
...
Red hat Enterprise Linux 7/CentOS 7
 a| 
<<install-mysql-redhat,Installieren Sie MySQL Server 5.5.30 oder höher und 5.6.x-Versionen unter Red hat Enterprise Linux 7 oder CentOS 7>>
...
Red Hat Enterprise Linux 8
 a| 
<<install-mariadb,Installieren Sie den MariaDB-Server unter Red hat Enterprise Linux 8>>
...
Sie müssen JDK auf Ihrem Hostsystem installieren, bevor Sie die Tiebreaker Software installieren oder aktualisieren. Tiebreaker 1.5 und höher unterstützt OpenJDK 17, 18 oder 19.
...
----
. Prüfen Sie auf verfügbare JDK-Versionen:
+
`yum search openjdk`

. Installieren Sie JDK 17,18 oder 19.
+
Mit dem folgenden Befehl wird JDK 17 installiert:
...
Sie müssen MySQL Server 5.5.30 oder höher und 5.6.x-Version auf Ihrem Hostsystem installieren, bevor Sie die Tiebreaker-Software installieren oder aktualisieren. Für Red Hat Enterprise Linux 8 <<install-mariadb,Installieren Sie den MariaDB-Server>>.
...
Sie müssen MariaDB Server auf Ihrem Hostsystem installieren, bevor Sie die Tiebreaker Software installieren oder aktualisieren. Für Red hat Enterprise Linux 7 oder CentOS 7, <<install-mysql-redhat,Installieren Sie MySQL Server>>.
...
link:install_tiebreaker_package.html["Installieren Sie das Softwarepaket"]
