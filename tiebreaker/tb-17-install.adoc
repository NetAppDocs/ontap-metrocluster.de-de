...
---
= Installieren Sie MetroCluster Tiebreaker 1.7
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installieren oder aktualisieren Sie Tiebreaker 1.7 auf Ihrem Linux-Host, um MetroCluster -Konfigurationen zu überwachen.

.Über diese Aufgabe
* Auf Ihrem Storage-System muss ONTAP 9.12.1 oder höher ausgeführt werden.
* Ein Upgrade auf Tiebreaker 1.7 ist nur von Tiebreaker 1.6P1 möglich. Siehelink:tb-16-install.html["Installieren Sie Tiebreaker 1.6 oder 1.6P1"] .
...
NOTE: Nach der Installation von Tiebreaker 1.7 müssen Sie link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Zertifikate importieren"] aktivieren, um eine nahtlose Überwachung zu ermöglichen.

.Schritte
. Laden Sie die Software MetroCluster Tiebreaker 1.7 herunter.
+
...
. Wenn Sie ein Upgrade durchführen, überprüfen Sie, welche Version von Tiebreaker Sie verwenden:
+
Das folgende Beispiel zeigt Tiebreaker 1.6P1
...
[role="tabbed-block"]
====
.Installieren Sie Tiebreaker 1.7
--
Führen Sie die folgenden Schritte für eine Neuinstallation von Tiebreaker 1.7 durch.
...
--
.Upgrade von 1.6P1 auf 1.7
--
Führen Sie die folgenden Schritte aus, um die Softwareversion Tiebreaker 1.6P1 auf Tiebreaker 1.7 zu aktualisieren.
...
NOTE: Falls Ihr Upgrade aufgrund fehlender Zertifikate mit einem Fehler fehlschlägt, lesen Sie bitte weiter unterlink:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Importzertifikate"] Die  Nachdem Ihre Zertifikate importiert wurden, können Sie ein erneutes Upgrade versuchen.
