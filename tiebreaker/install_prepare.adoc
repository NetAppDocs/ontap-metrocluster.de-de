...
---
= MetroCluster Tiebreaker Installationsanforderungen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Siehe link:whats_new.html#os-support-matrix["OS Support Matrix"] Entsprechende Details.
 a| 
Keine. OpenJDK 19.0.2 ist in der Installation enthalten.
...
* Wenn Sie Tiebreaker 1.5 oder höher installieren oder aktualisieren, link:install_security.html["Die MetroCluster Tiebreaker Host- und Datenbankinstallation absichern"].
* Wenn Sie Tiebreaker 1.4 installieren oder aktualisieren, link:install-dependencies-14.html["Installieren Sie MetroCluster Tiebreaker 1.4-Abhängigkeiten"].
