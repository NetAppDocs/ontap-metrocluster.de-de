...
---
= Die MetroCluster Tiebreaker Host- und Datenbankinstallation absichern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Die Verschlüsselung ruhender Daten wird unterstützt. link:https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals["Weitere Informationen zur Verschlüsselung ruhender Daten"^]
...
+
link:https://mariadb.com/docs/server/security/securing-mariadb["Sicherung von MariaDB"^]
...
link:install-choose-procedure.html["Wählen Sie Ihr MetroCluster Tiebreaker-Installationsverfahren"] Tiebreaker installieren oder aktualisieren.
