...
summary: Die Tiebreaker 1.4 Software bietet Monitoring-Funktionen für eine Clustered Storage-Umgebung. Außerdem sendet er SNMP-Benachrichtigungen, wenn Probleme mit der Node-Konnektivität oder im Falle eines Standortnotfalls auftreten. 
---
...
.Schritte
. <<install-java-1-8,Installieren Sie JDK>>.
...
.Schritte
. Melden Sie sich als an `root` Benutzer:
+
[listing]
----
...
link:install-tiebreaker-package-14.html["Installieren Sie das Softwarepaket"]
