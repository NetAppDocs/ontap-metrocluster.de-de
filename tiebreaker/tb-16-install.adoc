...
[role="lead"]
Führen Sie eine Neuinstallation oder ein Upgrade auf Tiebreaker 1.6 auf Ihrem Linux-Host-Betriebssystem durch, um die MetroCluster-Konfigurationen zu überwachen.
...
--
.Upgrade von Tiebreaker 1.5 auf 1.6
--
...
--
.Upgrade von Tiebreaker 1.4 auf 1.6
--
