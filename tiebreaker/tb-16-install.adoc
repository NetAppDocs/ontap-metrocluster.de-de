...
summary: Führen Sie eine Neuinstallation oder ein Upgrade auf Tiebreaker 1.6 auf Ihrem Linux-Host-Betriebssystem durch, um die MetroCluster-Konfigurationen zu überwachen. 
---
= MetroCluster Tiebreaker 1.6 oder 1.6P1 installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Führen Sie eine neue Installation oder ein Upgrade auf Tiebreaker 1.6 oder Tiebreaker 1.6P1 auf Ihrem Linux Host-Betriebssystem durch, um die MetroCluster-Konfigurationen zu überwachen.

.Über diese Aufgabe
* Auf Ihrem Storage-System muss ONTAP 9.12.1 oder höher ausgeführt werden.
...
NOTE: Nach der Installation von Tiebreaker 1.6 oder höher müssen Sie link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Zertifikate importieren"] aktivieren, um eine nahtlose Überwachung zu ermöglichen.



[[install-or-upgrade-to-tiebreaker-1-6p1]]
== Installation oder Upgrade auf Tiebreaker 1.6P1

Sie können Tiebreaker 1.6P1 installieren oder auf Tiebreaker 1.6P1 aus Tiebreaker 1.6, 1.5 oder 1.4 aktualisieren.

.Schritte
. Laden Sie die Software MetroCluster Tiebreaker 1.6P1 herunter.
+
...
. Wenn Sie ein Upgrade durchführen, überprüfen Sie die Version von Tiebreaker, die Sie ausführen:
+
Das folgende Beispiel zeigt Tiebreaker 1.5.
...
----
. Installieren oder aktualisieren Sie die Tiebreaker Software.
+
[role="tabbed-block"]
====
.Tiebreaker 1.6P1 installieren
--
Führen Sie die folgenden Schritte für eine Neuinstallation von Tiebreaker 1.6P1 aus.

.Schritte
.. Führen Sie den folgenden Befehl auf der aus `[root@mcctb ~] #` Aufforderung zum Starten der Installation:
+
[source, cli]
----
...
--
.Upgrade 1.6 auf 1.6P1
--
Gehen Sie wie folgt vor, um ein Upgrade der Tiebreaker 1.6 Softwareversion auf Tiebreaker 1.6P1 durchzuführen.


NOTE: Nach dem Upgrade auf Tiebreaker 1.6P1 von 1.6 entfernen Sie die vorhandenen Monitore und fügen die MetroCluster-Konfiguration für die Überwachung erneut hinzu.

.Schritte
.. Führen Sie den folgenden Befehl auf der aus `[root@mcctb ~] #` Aufforderung zum Aktualisieren der Software:
+
[source, cli]
----
sh MetroClusterTiebreakerInstall-1.6P1
...
----
=====
.. Entfernen Sie die MetroCluster-Konfiguration, und fügen Sie sie erneut hinzu, indem Sie die Schritte in ausführenlink:concept_configuring_the_tiebreaker_software.html["Konfigurieren der Tiebreaker Software"].


--
.Upgrade 1.5 auf 1.6P1
--
Gehen Sie wie folgt vor, um ein Upgrade der Tiebreaker 1.5 Softwareversion auf Tiebreaker 1.6P1 durchzuführen.
...
--
.Upgrade 1.4 auf 1.6P1
--
Gehen Sie wie folgt vor, um ein Upgrade der Tiebreaker 1.4 Softwareversion auf Tiebreaker 1.6P1 durchzuführen.
...
== Installieren Sie Tiebreaker 1.6 oder führen Sie ein Upgrade durch

Sie können Tiebreaker 1.6 installieren oder ein Upgrade auf Tiebreaker 1.6 über Tiebreaker 1.5 oder 1.4 durchführen.

.Schritte
. Laden Sie die Software MetroCluster Tiebreaker 1.6 herunter.
+
https://mysupport.netapp.com/site/products/all/details/metrocluster-tiebreaker/downloads-tab["MetroCluster Tiebreaker (Downloads) – NetApp Support-Website"^]
...
[role="tabbed-block"]
====
.Installieren Sie Tiebreaker 1.6
--
Führen Sie die folgenden Schritte aus, um Tiebreaker 1.6 neu zu installieren.
...
.Upgrade 1.5 auf 1.6
--
Gehen Sie wie folgt vor, um die Tiebreaker 1.5 Softwareversion auf Tiebreaker 1.6 zu aktualisieren.
...
.Upgrade 1.4 auf 1.6
--
Gehen Sie wie folgt vor, um die Tiebreaker 1.4 Softwareversion auf Tiebreaker 1.6 zu aktualisieren.
...
Nachdem Sie Tiebreaker erfolgreich installiert oder aktualisiert haben, link:configure-tb-workflow.html["Konfigurieren Sie die MetroCluster Tiebreaker-Software"] um MetroCluster-Konfigurationen hinzuzufügen und die erforderlichen Zertifikate zu importieren.
