...
* Wenn Sie einen Cisco 9336C-FX2 Switch mit NS224 Storage verkabeln, können Sie maximal zwei MetroCluster Konfigurationen oder DR-Gruppen haben. Mindestens eine MetroCluster Konfiguration oder DR-Gruppe muss NS224 Shelves mit dem MetroCluster Switch verbinden. Wenn eine Ihrer MetroCluster Konfigurationen oder DR-Gruppen ein System ist, das NS224 Shelves nicht unterstützt, kann es nur als zweite MetroCluster Konfiguration oder DR-Gruppe angeschlossen werden.
+
