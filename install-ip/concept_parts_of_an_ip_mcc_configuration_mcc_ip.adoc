...
---
= Informationen zu MetroCluster IP Hardwarekomponenten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/mcc_ip_hardware_architecture_mcc_ip.gif[MetroCluster IP-Hardwarearchitektur]
...
image::../media/mcc_dr_groups_4_node.gif[MetroCluster -DR-Gruppen in einer Konfiguration mit vier Knoten]
...
image::../media/mcc_ip_hardware_architecture_ha_pairs.gif[MetroCluster IP-Hardwarearchitektur HA-Paare]
...
image::../media/mcc_ip_hardware_architecture_ip_interconnect.png[MetroCluster IP-Hardwarearchitektur IP-Verbindung]
...
image::../media/mcc_ip_lif_usage.gif[MetroCluster IP LIF-Nutzung]
...
image::../media/mcc_ip_hardware_architecture_cluster_peering_network.gif[MetroCluster IP-Hardwarearchitektur Cluster-Peering-Netzwerk]
