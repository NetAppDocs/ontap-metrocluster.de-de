...
image::../media/mcc_ip_networking_with_shared_isls.gif[Beispiel für MetroCluster -IP-Netzwerke mit gemeinsam genutzten ISLs]
...
image::../media/mcc_ip_networking_with_intermediate_private_networks.gif[Beispiel für MetroCluster IP-Netzwerke mit zwischengeschalteten privaten Netzwerken]
...
image::../media/mcc_ip_two_mccs_sharing_the_same_shared_network_sx.gif[MetroCluster IP-Verkabelung mit zwei Konfigurationen, die dasselbe Zwischennetzwerk gemeinsam nutzen]
...
image::../media/mcc_ip_unsupported_two_mccs_direct_to_shared_switches.png[Beispiel einer nicht unterstützten Konfiguration von zwei MetroClustern, die direkt an gemeinsam genutzte Switches angeschlossen sind]
