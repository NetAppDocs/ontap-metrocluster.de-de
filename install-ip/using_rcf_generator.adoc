...
---
= Porttabellen für MetroCluster IP-Konfigurationen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es ist wichtig, die Informationen in den Porttabellen richtig zu nutzen, um die Referenzkonfigurationsdateien (RCFs) korrekt zu erstellen.
