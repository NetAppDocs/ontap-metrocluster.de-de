...
* Die Systeme AFF A30, AFF C30, AFF C60 und FAS50 benötigen einen QSFP-zu-SFP-Adapter in der Karte auf dem Controller, um eine Netzwerkgeschwindigkeit von 25 Gbit/s zu unterstützen.
