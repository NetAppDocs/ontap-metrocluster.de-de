...
+
** Bei AFF A1K und AFF A90 -Systemen muss die ISL-Geschwindigkeit mindestens 100 Gbit/s betragen. Für die Verwendung einer anderen ISL-Geschwindigkeit ist ein Feature Product Variance Request (FPVR) erforderlich. Um ein FPVR einzureichen, wenden Sie sich an Ihr Vertriebsteam.
** Auf allen anderen Plattformen muss die ISL-Geschwindigkeit mindestens 10 Gbit/s betragen.
