...
+
** Ab ONTAP 9.18.1 benötigen Plattformen mit einer MetroCluster IP-Backend-Portgeschwindigkeit von 100Gbps eine minimale ISL-Link-Geschwindigkeit von 100Gbps. Die Verwendung einer anderen ISL-Geschwindigkeit erfordert einen Feature Product Variance Request (FPVR). Um einen FPVR einzureichen, wenden Sie sich an Ihr NetApp Vertriebsteam.
+
