...
* Die ISLs in einer Fabric müssen die gleiche Topologie aufweisen. Sie sollten beispielsweise alle direkte Links sein, oder wenn die Konfiguration WDM verwendet, müssen alle WDM verwenden.
