...
48 Laufwerke (externe und interne Laufwerke)
 a| 
Die internen Partitionen sind in vier gleiche Gruppen (Quartiere) unterteilt. Jedes Quartal wird automatisch einem separaten Pool zugewiesen. Die Laufwerke auf den externen Regalen sind in vier gleiche Gruppen (Quartale) unterteilt. Jedes Quartal wird automatisch einem separaten Pool zugewiesen.
 a| 
