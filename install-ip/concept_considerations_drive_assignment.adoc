...
Sie müssen den ha-config-Status auf festlegen `mccip` Vor der automatischen Bereitstellung, um sicherzustellen, dass die richtigen Partitionsgrößen ausgewählt sind, um eine entsprechende Root-Volume-Größe zu ermöglichen. Weitere Informationen finden Sie unter link:install-ip/task_sw_config_verify_haconfig.html["Überprüfen des HA-Konfigurationsstatus von Komponenten"].
...
=== ADP- und Festplattenzuordnung auf Systemen AFF C250, AFF A250, ASA A250, ASA C250 und FAS500f
...
=== ADP und Festplattenzuweisung auf AFF A900 und ASA A900 Systemen
