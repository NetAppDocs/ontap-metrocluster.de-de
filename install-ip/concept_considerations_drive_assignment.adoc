...
ONTAP 9.4 und neuere Versionen beinhalten die folgenden Änderungen für ADP-Unterstützung:
...
NOTE: Ab ONTAP 9.5 muss die automatische Zuweisung von Festplatten mit dem Befehl aktiviert werden `storage disk option modify -autoassign on`.
...
=== ADP und Festplattenzuordnung auf AFF A220 Systemen
...
=== ADP und Festplattenzuordnung bei AFF A250-Systemen
...
=== ADP und Festplattenzuordnung auf AFF A400 Systemen
...
=== ADP und Festplattenzuordnung auf AFF A800 Systemen
