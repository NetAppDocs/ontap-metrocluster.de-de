...
summary: Konfigurieren Sie die MACsec-Verschlüsselung bei Bedarf nur auf den WAN-ISL-Ports, die zwischen den Standorten verlaufen. Wenn Sie die MACsec-Verschlüsselung verwenden möchten, konfigurieren Sie sie nach dem Anwenden der korrekten RCF-Datei. 
---
= Konfigurieren der MACsec-Verschlüsselung auf Cisco 9336C-Switches in einem MetroCluster IP-Standort (optional)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Bei Bedarf können Sie die MACsec-Verschlüsselung auf den WAN-ISL-Ports konfigurieren, die zwischen den Standorten verlaufen. Wenn Sie die MACsec-Verschlüsselung verwenden möchten, müssen Sie diese nach dem Anwenden der richtigen RCF-Datei konfigurieren.

[NOTE]
====
* Die MACsec-Verschlüsselung kann nur auf die WAN-ISL-Ports angewendet werden, die zwischen den Standorten verlaufen.
* Die Konfiguration der MACsec-Verschlüsselung ist bei der Konfiguration von Cisco 9336C Switches optional.
