...
summary: 'Ab ONTAP 9.5 unterstützt ONTAP Layer-3-Konnektivität mithilfe von Virtual IP (VIP) und Border Gateway Protocol (BGP).' 
---
= Verwendung eines virtuellen IP- und Border-Gateway-Protokolls mit einer MetroCluster-Konfiguration
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
