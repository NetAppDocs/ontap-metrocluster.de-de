...
---
= MetroCluster IP-Anforderungen für gemeinsam genutzte Layer-2- und Layer-3-Netzwerke
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/MCC_layer2.png[MetroCluster Layer 2-Netzwerkkonfiguration]
...
image::../media/mcc_layer3_backend.png[MetroCluster Layer 3-Backend-Netzwerkkonfiguration]
...
image::../media/switch_traffic_with_cisco_switches.png[Erforderliche Einstellungen bei Verwendung von NetApp -validierten Cisco -Switches für MetroCluster -Verkehr]
...
image::../media/switch_traffic_with_broadcom_switches.png[Erforderliche Einstellungen für das gemeinsam genutzte Netzwerk bei Verwendung von Broadcom IP-Switches]
