...
* Diese Aufgabe kann auf der ONTAP Schnittstelle eines beliebigen Knotens in der MetroCluster IP-Konfiguration ausgeführt werden.
...
IMPORTANT: Bevor Sie diesen Befehl verwenden, lesen Sie die link:concept-ontap-mediator-supports-automatic-unplanned-switchover.html#mauso-9-12-1["Risiken und Einschränkungen bei der automatischen erzwungenen MetroCluster Umschaltung"].
