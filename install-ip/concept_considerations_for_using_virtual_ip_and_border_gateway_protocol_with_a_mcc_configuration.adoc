...
---
= Informationen zu virtuellen IPs und BGP in einer MetroCluster IP Konfiguration
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/vip_and_bgp_in_metrocluster_2.png[Virtuelle IP und Border Gateway Protocol in MetroCluster]
