...
NOTE: Die MetroCluster-IP-Adresse und die verbundenen Switch-Ports werden erst online geschaltet, nachdem Sie die MetroCluster-IP-Schnittstellen erstellt haben.
