...
. Vergewissern Sie sich, dass ONTAP Mediator aus der MetroCluster Konfiguration entfernt wurde, indem Sie die folgenden Befehle auf beiden Clustern ausführen:
+
