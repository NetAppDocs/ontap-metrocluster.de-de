...
Ihre Version von ONTAP muss Shelf-Mix unterstützen. Siehe https://["NetApp Interoperabilitäts-Matrix-Tool (IMT)"] Um zu prüfen, ob Ihre Version von ONTAP Shelf-Mischungen unterstützt.
