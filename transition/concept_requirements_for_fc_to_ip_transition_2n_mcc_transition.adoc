...
---
= Vorbereitung auf einen disruptiven MetroCluster FC-zu-IP-Übergang
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/transition_2n_4_new_ip_nodes_on_the_shelves.png[Übergang mit vier neuen IP-Knoten auf bestehenden Regalen]
...
image::../media/workflow_2n_transition_bsaic.png[Workflow für den Zwei-Knoten-Übergang]
