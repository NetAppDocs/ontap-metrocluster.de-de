...
---
= Konfigurieren Sie MetroCluster für den Übergang
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wenn Sie den Onboard Key Manager verwenden, führen Sie die folgenden Schritte in dem Cluster aus, in dem Sie einen neuen Knoten hinzugefügt haben:
+
.. Synchronisieren Sie die Konfiguration des Schlüsselmanagers:
+
`security key-manager onboard sync`

.. Geben Sie bei Aufforderung die Passphrase des Onboard Key Managers ein.
