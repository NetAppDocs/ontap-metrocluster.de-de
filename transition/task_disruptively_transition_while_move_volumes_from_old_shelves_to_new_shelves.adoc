...
+
Diese Informationen sind für jedes Plattformmodell bei verfügbar https://["NetApp Hardware Universe"^]
...
+
http://["Erstellung eines Aggregats und Verschiebung von Volumes zu den neuen Nodes"^]
