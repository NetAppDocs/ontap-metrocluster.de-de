...
---
= Unterbrechende Umstellung von MetroCluster beim Ausmustern von Storage-Shelfs
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_2n_transition_moving_data_to_new_shelves.png[Workflow zum Verschieben von Daten in neue Regale während der Umstellung]
