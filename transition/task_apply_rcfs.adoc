...
---
= RCFs generieren und auf die neuen MetroCluster IP-Switches anwenden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Wenn Sie eine Umstellung von vier FC-Knoten auf acht IP-Knoten durchführen, kann die vier-Knoten-FC-zu-acht-Knoten-IP-RCF angewendet werden, bevor die zweite DR-Gruppe hinzugefügt wird. Die vier-Knoten-FC-zu-vier-Knoten-IP-RCF muss nicht zuerst angewendet werden.
