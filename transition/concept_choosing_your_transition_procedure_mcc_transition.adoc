...
image::../media/four_node_transition_mcc_9151.png[Zeigt unterstützte Plattformkombinationen für den IP- zu FC-Übergang]

* Anmerkung 1: Diese Plattformkombination erfordert ONTAP 9.13.1 oder höher.
* Hinweis 2: Auf FC-Nodes ist eine 100-GbE-Schnittstelle für die lokalen Cluster-Schnittstellen erforderlich. Für diese Plattformkombination ist ONTAP 9.11.1 oder höher erforderlich.
