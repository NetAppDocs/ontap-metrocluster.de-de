...
---
= Störungen beim Übergang, wenn MetroCluster Shelves auf neuen Controllern nicht unterstützt werden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_2n_transition_old_shelves_not_supported.png[Workflow für den Übergang, wenn alte Regale nicht unterstützt werden]
...
image::../media/transition_2n_unsupported_old_new_shelves_to_old_controllers.png[Verkabeln neuer Regale mit alten Controllern während der Umstellung]
