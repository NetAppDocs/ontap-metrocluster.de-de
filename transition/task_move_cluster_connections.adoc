...
Lokale Cluster-Schnittstelle am FC-Node
 ...
 a| 
Cisco 3232C oder 9336C-FX2
 a| 
Alle
 a| 
5, 6 oder 13, 14

*Hinweis:* Die Switch-Ports 13 und 14 können nur verwendet werden, wenn Sie zwei Geschwindigkeitsmodi auswählen.
 a| 
Lokale Cluster-Schnittstelle am FC-Node
 ...
 a| 
Cisco 9336C-FX2 freigegeben
 a| 
Alle
 a| 
3,4 oder 11,12

*Hinweis:* Die Switch-Ports 11 und 12 können nur verwendet werden, wenn Sie zwei Geschwindigkeitsmodi auswählen.
 a| 
Lokale Cluster-Schnittstelle am FC-Node
