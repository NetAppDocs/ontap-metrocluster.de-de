...
| Regale und Anzahl der Festplatten in jedem Regal sowie Details zum Flash-Speicher, Arbeitsspeicher, NVRAM und Netzwerkkarten | Auf dem System-Node wird -Node_Name sysconfig ausgeführt |  
...
image::../media/transition_2n_remove_fc_nodes.png[Entfernen von FC-Knoten während des Übergangs]
