...
image::../media/transition_2n_4_new_ip_nodes_and_shelves.png[Verkabelung neuer IP-Knoten und -Regale für den Übergang]
...
image::../media/transition_2n_booting_a_2_and_b_2.png[Booten neuer IP-Knoten während der Umstellung]
