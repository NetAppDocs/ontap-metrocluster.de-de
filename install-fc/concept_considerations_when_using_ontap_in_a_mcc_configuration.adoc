...
---
= ONTAP Überlegungen für MetroCluster Konfigurationen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/svm_dr_normal_behavior.gif[SVM-Notfallwiederherstellung im Dauerbetrieb]
...
+
image::../media/svm_dr_image_2.gif[SVM-Notfallwiederherstellung nach der Umstellung]
...
Einzelheiten zur Konfiguration einer SVM-DR-Beziehung sind im Abschnitt „link:http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-dap/home.html["Datensicherung mit der CLI"^]Replikation der SVM-Konfiguration“ zu finden.
...
image::../media/svm_dr_resynchronization.gif[SVM-Neusynchronisierung bei der Notfallwiederherstellung]
