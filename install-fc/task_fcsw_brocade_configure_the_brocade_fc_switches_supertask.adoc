...
---
= Die Brocade FC Switches werden manuell in einer MetroCluster FC Konfiguration eingerichtet
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Überprüfen Sie die Lizenzanforderungen von Brocade
...
== Setzen Sie die Brocade FC-Switch-Werte auf die Werkseinstellungen
...
+
https://docs.netapp.com/us-en/ontap-metrocluster/install-fc/concept_configure_the_mcc_software_in_ontap.html#configuring-in-order-delivery-or-out-of-order-delivery-of-frames-on-ontap-software["Konfigurieren Sie die In-Order-Zustellung oder Out-of-Order-Zustellung von Frames auf der ONTAP -Software"]





. Wenn Sie eine Version vor FOS 9.0 ausführen, überprüfen Sie, ob der Switch die dynamische Port on Demand (POD)-Lizenzierungsmethode verwendet.
+
...
== Konfigurieren Sie die grundlegenden Switch-Einstellungen auf einem Brocade DCX 8510-8-Switch
...
== Konfigurieren Sie E-Ports auf Brocade FC-Switches mithilfe von FC-Ports
...
== Konfigurieren Sie 40-Gbit/s-VE-Ports auf Brocade 7810- und 7840-FC-Switches
...
== Konfigurieren Sie die Nicht-E-Ports auf dem Brocade -Switch
...
== Konfigurieren Sie Zoning auf Brocade FC-Switches
...
=== Zonen für FC-VI-Ports einrichten
...
=== Zone FibreBridge 7500N- oder 7600N-Brücken mit einem FC-Port
...
|===
| FC Switch | Standort | Switch-Domäne | Brocade 6505, 6510, 6520, G620, G610 oder G710 Switch-Port | Verbindung wird hergestellt mit... 
...
|===
| FC Switch | Standort | Switch-Domäne | Brocade 6505-, 6510-, 6520-, G620-, G610- oder G710-Switch | Verbindung wird hergestellt mit... 
...
=== Zone FibreBridge 7500N-Brücken verwenden beide FC-Ports
...
| FC Switch | Standort | Switch-Domäne | 6505 / 6510 / G610 /G710 / G620-Anschluss | 6520 Anschlüsse | Verbindung wird hergestellt mit... 
...
| FC Switch | Standort | Switch-Domäne | 6505 / 6510 / G610 / G710-Anschluss | 6520 Anschlüsse | G620-Anschluss | Verbindung wird hergestellt mit... 
...
| FC Switch | Standort | Switch-Domäne | 6505 / 6510 / G610 / G710 | 6520 | G620 | Verbindung wird hergestellt mit... 
...
=== Zonieren Sie die Brocade FC-Switches
...
== ISL-Verschlüsselung auf Brocade 6510- oder G620-Switches einrichten
...
=== Virtuelles Fabric deaktivieren
