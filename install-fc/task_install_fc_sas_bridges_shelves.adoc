...
== Unterstützte Anzahl an Festplatten und Shelfs auf FibreBridge 7600N- und 7500N-Bridges

Die folgenden Tabellen enthalten die Anzahl der Festplatten und Shelfs, die hinter einem Paar FibreBridge 7600N- und 7500N-Bridges unterstützt werden.

[NOTE]
====
* Die erste Grenze, die Sie erreichen, gilt.
* Bei Verwendung von DS460C Shelfs können nur bis zu 240 Laufwerke verwendet werden, was 4 Shelfs entspricht.
* Bei DS212C Shelfs können nur bis zu 120 Laufwerke verwendet werden, was 10 Shelfs entspricht.


====
.Unterstützte Festplattenanzahl
Prüfen Sie die Anzahl der unterstützten Festplatten hinter einem Paar FibreBridge 7600N- oder 7500N-Bridges:

[cols="3*"]
|===
| Festplattenkonfiguration | Festplattentyp | Festplatten pro Bridge-Paar insgesamt 


| Ausschließlich SSDs | SSD | 96 


| Alle HDDs | HDD | 240 


.2+| Gemischt (96 SSDs) | SSD | 96 


| HDD | 144 


.2+| Gemischt (72 SSDs) | SSD | 72 


| HDD | 168 


.2+| Gemischt (48 SSDs) | SSD | 48 


| HDD | 192 


.2+| Gemischt (24 SSDs) | SSD | 24 


| HDD | 216 
|===
.Unterstützte Anzahl an Shelfs
Sehen Sie sich die Anzahl der unterstützten Shelves hinter zwei FibreBridge 7600N- und 7500N-Bridges an:

[cols="3*"]
|===
| Festplattenkonfiguration | Festplattentyp | Gesamtanzahl der Shelfs 


| Ausschließlich SSDs | SSD | 4 
