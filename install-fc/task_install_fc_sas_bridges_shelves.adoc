...
---
= FC-zu-SAS-Bridges und SAS-Disk-Shelves in einer MetroCluster FC Konfiguration installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_bridge_installation_and_configuration.gif[Workflow Installation und Konfiguration der FC-zu-SAS-Brücke]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[MetroCluster -Verkabelung für FibreBridge mit mehreren SAS3-Stacks]
