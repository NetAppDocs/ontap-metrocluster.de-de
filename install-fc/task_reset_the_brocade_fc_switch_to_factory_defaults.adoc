...
---
= Den Brocade FC Switch in einer MetroCluster FC Konfiguration auf die Werkseinstellungen zurücksetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wenn Sie eine Version vor FOS 9.0 ausführen, überprüfen Sie, ob der Switch die dynamische Port-on-Demand-Methode (POD) verwendet.
+
...
+
Bei Brocade Fabric OS-Versionen vor 8.0 führen Sie die folgenden Befehle als admin aus, für Versionen 8.0 und höher führen Sie sie als root aus.
