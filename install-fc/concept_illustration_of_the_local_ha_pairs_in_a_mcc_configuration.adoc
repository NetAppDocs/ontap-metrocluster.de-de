...
---
= Illustration der lokalen HA-Paare in einer MetroCluster FC-Konfiguration
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/mcc_hw_architecture_local_ha.gif[Lokale HA-Paare der MetroCluster -Hardwarearchitektur]
