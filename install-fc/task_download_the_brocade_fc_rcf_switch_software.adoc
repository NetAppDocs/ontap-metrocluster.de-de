...
---
= Die Brocade FC Switch RCF-Datei in einer MetroCluster FC-Konfiguration herunterladen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Für die Nutzung dieser RCFs muss auf dem System ONTAP 9.1 oder höher ausgeführt werden und das Port-Layout für ONTAP 9.1 oder höher zum Einsatz kommen.
...
.Schritte
. In der RCF-Tabelle auf der Brocade RCF-Downloadseite lässt sich die richtige RCF für jeden Switch in Ihrer Konfiguration ermitteln.
+
Die RCFs müssen auf die richtigen Switches angewendet werden.

. Die RCFs für die Switches können von der  https://mysupport.netapp.com/site/products/all/details/metrocluster-rcf/downloads-tab["MetroCluster RCF-Download"] Seite heruntergeladen werden.
+
