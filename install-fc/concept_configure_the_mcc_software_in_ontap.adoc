...
==== AutoSupport-Informationen zu Standort A
...
==== AutoSupport-Informationen zu Standort B
...
==== SP-Informationen zu Standort B
...
Weitere allgemeine Informationen zum Einrichten von ONTAP finden Sie im https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["Einrichtung von ONTAP"]
...
+
Im folgenden Beispiel werden Intercluster-LIFs cluster01_ic.01 und cluster01_ic02 erstellt:
...
NOTE: Wenn Sie ein einzelnes gespiegeltes Datenaggregat verwenden möchten, finden Sie weitere Informationen unter ,Schritt 1 Weitere Anweisungen.
