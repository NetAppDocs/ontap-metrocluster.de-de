...
---
= Cisco Switches manuell in einer MetroCluster FC Konfiguration konfigurieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/fcip_ports_dual_isl.gif[Diagramm, das FCIP-Ports mit dualer ISL-Konfiguration auf jedem Switch zeigt]
...
Die folgenden Schritte verwenden die im Abschnitt „Zoning für eine FibreBridge 7500N in einer MetroCluster -Konfiguration mit vier Knoten“ beschriebene Zoning.
