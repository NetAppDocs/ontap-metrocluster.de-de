...
image::../media/mcc_dr_groups_8_node.gif[MetroCluster DR gruppiert acht Knoten]

Die folgende Abbildung zeigt die Organisation der Nodes in einer MetroCluster Konfiguration mit vier Nodes:

image::../media/mcc_dr_groups_4_node.gif[MetroCluster DR gruppiert vier Knoten]
...
image::../media/mcc_hardware_architecture_both_clusters.gif[MetroCluster -Konfiguration mit vier Knoten in beiden Clustern]
...
image::../media/mcc_hardware_architecture_cluster_a_with_7500n.gif[MetroCluster -Cluster A-Konnektivität mit FibreBridge 7500N-Brücken]
...
image::../media/mcc_hardware_architecture_both_clusters_2_node_fabric.gif[Zwei-Knoten-Fabric MetroCluster -Konfiguration, beide Cluster]
...
image::../media/mcc_hardware_architecture_cluster_a_2_node_with_7500n.gif[Zwei-Knoten- MetroCluster -Cluster-A-Konnektivität mit FibreBridge 7500N-Brücken]
