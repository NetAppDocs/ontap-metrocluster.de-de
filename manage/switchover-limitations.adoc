...
[role="lead"]
Wenn sich das System im Umschaltmodus befindet, empfiehlt NetApp, bestimmte Vorgänge zu vermeiden.

Die folgenden Vorgänge werden während der Systemumstellung nicht empfohlen und sollten nur unter Anleitung des NetApp Supports durchgeführt werden:

* Aggregate erstellen oder löschen
* Erstellen oder Löschen von Volumes (einschließlich verschlüsselter Volumes)
