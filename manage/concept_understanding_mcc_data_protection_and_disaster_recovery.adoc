...
---
= Informationen zu MetroCluster Datenschutz und Notfallwiederherstellung
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/mcc_hw_architecture_local_ha.gif[Lokale HA in einer MetroCluster -Konfiguration]
...
image::../media/mcc_mirroring_of_svms.gif[MetroCluster -Spiegelung von SVMs]
...
image::../media/mcc_svms_after_switchover.gif[MetroCluster SVMs nach der Umstellung]
...
| Art der Umschaltung | Status der MetroCluster FC-Konfiguration | MetroCluster IP-Konfigurationsstatus 
...
|===
*Hinweis 1*: In MetroCluster IP-Konfigurationen können Sie nach Abschluss der Umschaltung die nicht gespiegelten Aggregate manuell online bringen.

Weitere Informationen zu <<Unterschiede bei der Umschaltung zwischen MetroCluster FC- und IP-Konfigurationen>>.
...
image::../media/mcc_mirroring_of_pools.gif[MetroCluster -Spiegelung von Speicherpools]
...
| In einer MetroCluster-Konfiguration | In einem nicht-MetroCluster HA-Paar 
 ...
 a| 
image:../media/mcc_nvram_quartering.gif["Nichtflüchtige Cache-Viertelierung in der MetroCluster -Konfiguration"]
 a| 
image:../media/mcc_nvram_split_in_non_mcc_ha_pair.gif["Aufteilung des nichtflüchtigen Caches in Nicht- MetroCluster -HA-Paar"]
...
image::../media/mcc_nvram_mirroring_example.gif[Beispiel für MetroCluster NVRAM -Spiegelung]
...
image::../media/mcc_nvram_mirroring_example_dynamic_dr_aux.gif[MetroCluster NVRAM -Spiegelung mit DR-Hilfsspeicher]
...
image::../media/mcc_disk_ownership.gif[MetroCluster Festplattenbesitz]
...
image::../media/mcc_so_sb_with_autoheal.gif[MetroCluster -Switchover und Switchback mit Autoheal]
...
image::../media/mcc_uso_with_autoheal.gif[Ungeplante Umschaltung von MetroCluster mit Autoheal]
