...
---
= Das richtige MetroCluster Wiederherstellungsverfahren auswählen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
| Umfang der Ausfälle am Disaster-Standort | Verfahren 
 ...
 a| 
* Kein Hardwarefehler (z. B. ein Stromausfall)
...
+
image::../media/mcc_dr_groups_8_node_with_a_single_controller_failure.gif[MetroCluster -DR-Gruppen mit acht Knoten und Ausfall eines einzelnen Controllers]
...
image::../media/mcc_dr_groups_8_node_with_a_multi_controller_failure.gif[MetroCluster -DR-Gruppen mit acht Knoten und Ausfall mehrerer Controller]
...
image::../media/mcc_dr_groups_8_node_with_two_single_controller_failures.gif[MetroCluster -DR-Gruppen mit acht Knoten und zwei einzelnen Controller-Ausfällen]
...
image::../media/mcc_dr_groups_8_node_with_a_3_controller_failure.gif[MetroCluster DR-Gruppen mit acht Knoten und drei Controller-Ausfällen]
...
image::../media/mcc_dr_groups_2_node_with_a_single_controller_failure.gif[MetroCluster DR-Gruppen mit zwei Knoten und Ausfall eines einzelnen Controllers]
