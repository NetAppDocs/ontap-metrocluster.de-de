...
---
= Wiederherstellung nach einem Ausfall mehrerer Controller oder des Speichersystems in MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_smoking_crater_recovery.png[Workflow zur Wiederherstellung nach einem Multi-Controller-Fehler]
