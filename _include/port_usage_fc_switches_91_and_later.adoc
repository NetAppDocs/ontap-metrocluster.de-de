...
21
 ...
 a| 
&Ast; die Ports 12 bis 15 sind für die zweite MetroCluster oder DR-Gruppe auf dem Brocade 7840 Switch reserviert.
...
| FibreBridge 7500 mit zwei FC-Ports | Port | Switch | Schalter 2 
...
|===
Zusätzliche Bridges für eine zweite DR-Gruppe oder eine zweite MetroCluster-Konfiguration können mithilfe derselben Port-Nummern auf dem zweiten MDS-Modul verbunden werden.
