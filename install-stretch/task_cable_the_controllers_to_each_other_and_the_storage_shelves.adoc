...
---
= Kabeldehnung MetroCluster Controller und Storage Shelves
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/mcc_cabling_fc_vi_controller_to_partner.gif[MetroCluster -Verkabelung des FC VI-Controllers mit dem Partner]
...
+
image::../media/mcc_two_node_optical_sas_space_configuration.png[Optische SAS-Konfiguration mit zwei Knoten]
