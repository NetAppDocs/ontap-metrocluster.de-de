...
---
= Die Stretch MetroCluster Konfiguration testen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dieser Test bestätigt, dass die Datenverfügbarkeit durch die Umstellung des Clusters auf das zweite Rechenzentrum nicht beeinträchtigt wird (mit Ausnahme der SMB- und Fibre Channel-Protokolle).
