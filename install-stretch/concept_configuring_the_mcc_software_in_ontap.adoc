...
---
= Die Stretch MetroCluster Software in ONTAP konfigurieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[Workflow-Diagramm für die Knoten- und Clusterkonfiguration in ONTAP]
...
Weitere allgemeine Informationen zur Einrichtung von ONTAP finden sich unter link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["Einrichtung von ONTAP"^]
...
* Laufwerke sind Eigentum eines bestimmten Nodes. Wenn Sie ein Aggregat erstellen, müssen alle Laufwerke in diesem Aggregat im Besitz desselben Nodes sein, der zum Home-Node für das Aggregat wird.
* Aggregatnamen sollten dem Benennungsschema entsprechen, das Sie beim Planen Ihrer MetroCluster-Konfiguration ermittelt haben.
* Die link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["Festplatten- und Aggregatmanagement"^] enthält weitere Informationen über Spiegelungsaggregate.
...
+
Der link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sag/home.html["Cluster-Management mit der CLI"^] enthält zusätzliche Informationen im Abschnitt „Verwaltung von Konfigurationssicherungen“.
