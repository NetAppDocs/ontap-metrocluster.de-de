...
+
Sie müssen mit „`y`“ antworten, wenn Sie aufgefordert werden, den erweiterten Modus fortzusetzen, und Sie sehen die Eingabeaufforderung für den erweiterten Modus (*>).
